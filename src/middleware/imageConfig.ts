import { NextFunction, raw, Request, RequestHandler, Response } from "express";
...
function processImagetojpg(field: string): Array<RequestHandler> {
    return [
        multerconfig.single(field),
